...
<%
String resolveTemplate=ics.GetVar("resolvetemplatefordevice");
%>
<render:gettemplateurl	outstr="_pageUrl" tname='<%= ics.GetVar("template")%>' c="Page" cid='<%=ics.GetVar("assetid") %>' ttype="CSElement" resolvetemplatefordevice='<%=resolveTemplate %>' d='<%=ics.GetVar("d") %>'/>					
