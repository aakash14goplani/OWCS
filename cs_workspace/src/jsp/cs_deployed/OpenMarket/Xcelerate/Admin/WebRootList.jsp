...
<%//
// OpenMarket/Xcelerate/AssetType/DeviceGroup/DeviceGroupList
//
// INPUT
//
// OUTPUT
...
<asset:list type="WebRoot" list="WebRootList" excludevoided="true"/>

<table class="width-outer-70" cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td>
			<span class="title-text"><xlat:stream key="dvin/TreeApplet/WebRoots"/></span>
		</td>
	</tr>
		...
		<td >
			<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" >
				...
				<tr>
					...
					<td class="tile-b" background='<%=ics.GetVar("cs_imagedir") + "/graphics/common/screen/grad.gif"%>'>
						<DIV class="new-table-title"><xlat:stream key="UI/Forms/RootURL"/></DIV>
					</td>
					<td class="tile-b" background='<%=ics.GetVar("cs_imagedir") + "/graphics/common/screen/grad.gif"%>'>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				...
				<ics:if condition='<%=null != ics.GetList("WebRootList") && ics.GetList("WebRootList").hasData() %>'>
				<ics:then>																
					<ics:listloop listname="WebRootList">
						<ics:setvar name="separatorLine" value="1"/>	
						<ics:listget listname="WebRootList" fieldname="name" output="_name"/>
						<ics:listget listname="WebRootList" fieldname="id" output="_id"/>
						<tr class='<%=ics.GetVar("rowStyle") %>'>
							<td><BR /></td>
							<td VALIGN="TOP" NOWRAP="NOWRAP" ALIGN="LEFT">
								<ics:callelement element="OpenMarket/Xcelerate/Util/GenerateLink">
									<ics:argument name="assettype" value="WebRoot"/>
								...
								<DIV class="small-text-inset">
									<xlat:lookup key="dvin/Common/Inspect" varname="_XLAT_" escape="true"/>
				             		<A HREF='<%=ics.GetVar("urlInspectItem") %>' >
				             			<ics:listget listname="WebRootList" fieldname="name"/>
				             		</A>
								</DIV>
							</td>
							<td><BR /></td>
							<td VALIGN="TOP" ALIGN="LEFT">
								<DIV class="small-text-inset">
									<ics:listget listname="WebRootList" fieldname="rooturl"/>
								</DIV>
							</td>
							<td></td>
							<td><BR /></td>
