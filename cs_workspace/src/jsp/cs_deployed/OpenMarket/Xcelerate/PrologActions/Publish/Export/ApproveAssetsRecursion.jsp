...
<%//
// OpenMarket/Xcelerate/PrologActions/Publish/Export/ApproveAssetsRecursion
// This element is a re-write of the original ApproveAssets code in JSP. (moved to ApproveAssetsLegacy)
// It should work the same with the addition of recursion. 
//
// INPUT
//
// OUTPUT
