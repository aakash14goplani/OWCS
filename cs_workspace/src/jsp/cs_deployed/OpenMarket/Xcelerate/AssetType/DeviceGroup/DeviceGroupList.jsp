...
<asset:list type='<%=ics.GetVar("AssetType") %>' list="DeviceList" field1="category" value1="m" order="priority asc" excludevoided="true" pubid='<%=ics.GetSSVar("pubid") %>' />

<table class="width-outer-70" cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td>
			<span class="title-text"><xlat:stream key="dvin/AdminForms/DeviceGroups"/></span>
		</td>
	</tr>
