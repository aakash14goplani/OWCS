...
<%//
// OpenMarket/Xcelerate/AssetType/Dimension/ShowDimensionForm
//
// INPUT
//
// OUTPUT
...
<ics:then>
	...
	<ics:then>
	    ...
	    %>
		<asset:scatter name='<%=ics.GetVar("assetname")%>' fieldlist="Dimension,Dimension-parent" prefix='<%=ics.GetVar("dimVarPrefix")%>'/>
		...
		<ics:then>
			...
			<tr>
				...
				<td />
				<td class="form-inset"><ics:callelement element="OpenMarket/Xcelerate/AssetType/Dimension/PickDimensionForm"/></td>
			</tr>
		</ics:then>
		</ics:if>
		<%	} %>
