...
%><%// fatwire/systemtools/logs/logTailViewer
%><%@ taglib prefix="cs" uri="futuretense_cs/ftcs1_0.tld"
%><%@ taglib prefix="ics" uri="futuretense_cs/ics.tld"
%><%@ taglib prefix="xlat" uri="futuretense_cs/xlat.tld"
%><%@ taglib prefix="satellite" uri="futuretense_cs/satellite.tld"
%><cs:ftcs>
<ics:callelement element="OpenMarket/Gator/UIFramework/UITimeOutPopup" />
...
if(Boolean.valueOf(ics.GetVar("logOK")))
{
    ...
    String pageSize = ics.GetVar(LogAnalyzer.PAGESIZE);
    if (pageSize == null)
        pageSize = UIConstants.DEFAULT_PAGESIZE;
%>
	...
	<tr>
		        ...
		        <td nowrap="nowrap">
					<div class="form-inset">
						<select id='<%= LogAnalyzer.PAGESIZE%>' name='<%= LogAnalyzer.PAGESIZE%>'><%for(String size : UIConstants.ELEM_PAGESIZE_OPTS) {%><option value='<%= size%>' <%= pageSize.equals(size) ? "selected" : ""%>><%= size%></option><%}%>
