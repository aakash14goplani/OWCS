...
<% 
ics.LogMsg("Inside personalizeNavbar ");
	//ics.LogMsg("Site Entry in personalizeNavbar  : "+ics.GetVar("seid")); commenting since cannot crate site entry
	//ics.LogMsg("CSElement in personalizeNavbar  : "+ics.GetVar("eid"));
