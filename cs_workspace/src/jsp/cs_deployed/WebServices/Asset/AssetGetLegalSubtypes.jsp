...
<%
// get input:
String sType = ics.GetVar("TYPE");
String sSite = ics.GetVar("PUBID");
if (ics.systemDebug())
{
	String msg = "Getting a list of legal subtypes for type="+sType;
	if (sSite != null)
		msg+= " and site="+sSite;
	ics.LogMsg(msg);
}
FTValList vl = new FTValList();
vl.setValString("TYPE",sType);
if (sSite!=null)
	vl.setValString("PUBID","sSite");
vl.setValString("LIST","outList");
ics.runTag("ASSET.GETLEGALSUBTYPES",vl);
if (ics.GetErrno() < 0) 
{
	ics.LogMsg("Error getting list of legal subtypes:"+ics.GetErrno());
}
