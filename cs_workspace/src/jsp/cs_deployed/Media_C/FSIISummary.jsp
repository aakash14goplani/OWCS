...
<render:lookup key="ThumbnailFile" match=":x" varname="ThumbnailFile" />
...
<assetset:getattributevalues name="MediaSet" attribute='<%=ics.GetVar("ThumbnailFile")%>' listvarname="File" typename='<%=ics.GetVar("MediaAttrType")%>' />
...
<ics:then>
	...
	<img src="<string:stream variable="imgurl"/>" class="ImageSummary"
