...
<span dojoType="fw.ui.dijit.insite.MultivaluedContainer" 
	editor="fw.ui.dijit.insite.CKEdit"
	attrType="richTextField"
	dialogType="MultiValuedCKEditorDialog"
	buttons="${cs.buttons}"
	editorParams='{config: ${cs.editorParams}, required: ${cs.isRequired},enableEmbeddedLinks:${cs.allowEmbeddedLinks}}' 
