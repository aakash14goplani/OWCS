...
<%//
// fatwire/wem/ui/admin/site/Edit
//
// INPUT
//
// OUTPUT
...
<ics:setvar name="cspath" value="../../../../.."/>
   <ics:callelement element="fatwire/wem/ui/admin/Heading"> 
      <xlat:lookup key="fatwire/wem/admin/site/edit/Heading" varname="_XLAT_"/>
	  <ics:argument name="Heading:title" value='<%=ics.GetVar("_XLAT_")%>'/>
</ics:callelement>
<input type="hidden" id="pageId" value="site/Edit"/>
...
<p></p>
     ...
     <xlat:lookup key="fatwire/wem/admin/site/edit/EditSite" varname="_XLAT_"/>
     ...
     <div class="row">
      ...
      <div dojoType="fw.dijit.UIInput" name="wem:AdminUI.name" required="true" disabled="true"></div>
     </div>
     ...
     <div class="buttonsrow">
      <label>&nbsp;</label>
	   <button id="btnSaveAndClose" dojoType="fw.ui.dijit.Button" buttonType="OK wemButtonStyle" buttonStyle="grey" onClick="AdminUIManager.submitForm(dojo.byId('mainform')['wem:AdminUI.name'].value,'site/Browse',true,false,'Site')">
		<xlat:stream  key='fatwire/wem/admin/common/actions/SaveAndClose'/>
	  </button>	   
      <span style="top:0;" id="btnSave" dojoType="fw.dijit.UIActionLink"
       onClick="AdminUIManager.submitForm(dojo.byId('mainform')['wem:AdminUI.name'].value,'site/Browse',false,false,'Site');"
       ><xlat:stream key="fatwire/wem/admin/common/actions/Save"/></span>
      <span style="top:0;" onclick="AdminUIManager.loadPage('site/Browse','prev');" class="button"><xlat:stream key="fatwire/wem/admin/common/actions/Cancel"/></span>
     </div>
   ...
   <ics:callelement element="fatwire/wem/ui/admin/Description"> 
      <xlat:lookup key="fatwire/wem/admin/site/edit/DescriptionTitle" varname="_XLAT_"/>
      <ics:argument name="Description:heading" value='<%=ics.GetVar("_XLAT_")%>'/>
	  <xlat:lookup key="fatwire/wem/admin/site/edit/DescriptionBody" varname="_XLAT_" encode="false"/>
