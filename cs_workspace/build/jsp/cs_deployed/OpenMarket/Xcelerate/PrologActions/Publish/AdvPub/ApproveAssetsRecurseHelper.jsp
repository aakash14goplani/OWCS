...
<%//
// OpenMarket/Xcelerate/PrologActions/Publish/AdvPub/ApproveAssetsRecurseHelper
//
// INPUT
//      anAsset
//      target
        ...
        if (!depsToApproveMap.isEmpty())
        {
            for (String assettype : depsToApproveMap.keySet())
            {
                ...
                for (String key : tempMap.keySet())
                {
                    ...
                    ics.CallElement("OpenMarket/Xcelerate/PrologActions/Publish/AdvPub/ApproveAssetsRecurseHelper", lin);
                    ...
                    if(!"true".equalsIgnoreCase(ics.GetVar("dryrun")))
                    {
	                    ...
	                    lin.setValString("target", ics.GetVar("target"));
	                    ics.CallElement("OpenMarket/Xcelerate/PrologActions/Publish/AdvPub/ApproveAsset", lin);
                    }
                    %>
                    <%--<asset:get name="anAsset" field='name'/>--%>
                    <%--<asset:get name="anAsset" field='id'/>--%>
