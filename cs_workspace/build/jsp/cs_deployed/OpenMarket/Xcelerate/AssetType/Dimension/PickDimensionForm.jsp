    ...
    else
    {
        ...
        <ics:then>
            ...
            <ics:listloop listname='listLocales' >
                ...
                <ics:listget listname='listLocales' fieldname='name' output='dname'/>
                <%
                if(ics.GetVar("ddescription") == null || "".equals(ics.GetVar("ddescription").trim())){
                	ics.SetVar("ddisplayvalue",ics.GetVar("dname"));
                } else {
                	ics.SetVar("ddisplayvalue",ics.GetVar("ddescription"));
                }
				...
				*/
                ...
                %>
                <option value='<%=ics.GetVar("did")%>' <%=selected%> ><string:stream variable="ddisplayvalue"/></option>
            </ics:listloop>
