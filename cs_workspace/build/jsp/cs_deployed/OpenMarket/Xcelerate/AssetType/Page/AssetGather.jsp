...
private static final String FLEXASSET_FIELDLIST = "name,description,flextemplateid,Webreference,template,filename,path,Dimension,Dimension-parent,startdate,enddate,subtype,category";
