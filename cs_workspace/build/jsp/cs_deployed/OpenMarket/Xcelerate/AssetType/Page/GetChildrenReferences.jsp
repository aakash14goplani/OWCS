...
<!--  Create the list which will be populated 
	  with attribute asset references 
      of children  
-->
...
for(AssetId child : children ) {
	...
	%>
     ...
     <listobject:argument name='type' value='<%=child.getType()%>'/>
		<listobject:argument name='id' value='<%=String.valueOf(child.getId())%>'/>
