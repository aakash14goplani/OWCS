...
<%//
// OpenMarket/Xcelerate/Actions/AssetMgt/ITileHeldAssets
//
// INPUT
//
// OUTPUT
...
<html>
<head>
<satellite:link assembler="query" pagename="OpenMarket/Xcelerate/Actions/AssetMgt/TileHAssets" outstring="tileHAssetsURL">
    ...
    <satellite:argument name="docheckbox" value='<%=ics.GetVar("docheckbox")%>'/>
</satellite:link>
...
function init(){
	...
	updatePanel('_t1','<%=ics.GetVar("tileHAssetsURL")%>&divContainerId=_t1');
}
