...
try
{
	...
	{
	    String detailUrl = ics.GetVar("cgManagementUrl") + "/rest/sites/detail/CGPoll"
		...
		if (resp.optString("status").equals("success"))
		{
			...
			question = resp.optString("question");
			startDate = resp.optString("startDate");
			finishDate = resp.optString("finishDate");
			modifiedDate = resp.optString("modifiedDate");
		}
	}
}
catch(Exception e){}
