		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td></td>
					<td class="form-inset">
						<asset:list list="asset" excludevoided="true" type="YouTube" field1='id' value1='<%=ics.GetVar("id") %>'/>
						<ics:listget listname="asset" fieldname="externalid" output="videoId" />
						<iframe id="ytplayer" type="text/html" width="420" height="260"
								src="http://www.youtube.com/embed/<ics:getvar name="videoId"/>" frameborder="0"></iframe>
					</td>
				</tr>
				<ics:callelement element="OpenMarket/Xcelerate/UIFramework/Util/RowSpacer"/>
				<tr>
