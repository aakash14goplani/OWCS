...
<!--   
	...
	The tree tag is now optional for the  Content tag 
	The source property OF THE CONTENT tag  is the plug-in 
	cs source element which will be responsible for rendering 
	any "content" data display 
-->	    
<leftnavconfig>
	<panes>
